  ...
  return (
    <footer className="text-center lg:text-left bg-gray-900 text-gray-100">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
          ...
          ">
              ...
              TRUNKEY TWITTER ANALYTICS
            </h6>
            <p>
              For better tweet analysis, we have developed a crawler that can crawl tweets from Twitter
            </p>
          </div>
          <div className="">
            <h6 className="uppercase font-semibold text-primary mb-4 flex justify-center md:justify-start">
              Useful links
            </h6>
            <p className="mb-4">
      ...
      <div className="text-center p-6 bg-primary">
        ...
        <a className="text-gray-100 font-semibold">TwitterAnalytics</a>
      </div>
    </footer>
  )
}
